...
public class interactive_btn_vr_valiplc : MonoBehaviour
{
    public VRInteractiveItem btnObj;
    private Control_Panel_Button scriptControlPanel;
    ...
    private void Awake()
    {
        scriptControlPanel = GameObject.FindGameObjectWithTag(TAG).GetComponent<Control_Panel_Button>();
    }
